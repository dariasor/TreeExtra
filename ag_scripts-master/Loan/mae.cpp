//mae.cpp: main function of an executable mae.exe
//Calculates mean average error from predictions and target values. 
...
int main(int argc, char* argv[])
{
	...
	if(argc != 3)
		throw string("Usage: mae _targets_ _predictions_");
	...
	for(int itemNo = 0; itemNo < itemN; itemNo++)
		mae += abs(preds[itemNo] - tars[itemNo]);
